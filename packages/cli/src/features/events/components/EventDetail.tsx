    ...
    return (
      <Box flexDirection="column" flexGrow={1}>
        ...
        <Box paddingX={2} paddingY={1}>
          <Text color={theme.ui.textMuted}>ESC Back</Text>
        </Box>
      </Box>
    );
  }
    ...
    <Box flexDirection="column" flexGrow={1}>
      ...
      <Box flexDirection="column" paddingX={2} paddingY={1} flexGrow={1}>
        ...
        <LayoutAwareList
          ...
          onSelect={() => {}} // No selection action needed for display-only content
          ...
          testMode={true}
          localHeightOffset={
            9 + (copyMessage ? 2 : 0) + (showExportOptions ? 3 : 0)
          } // Metadata (4) + Tabs (1) + margins (4)
        />
