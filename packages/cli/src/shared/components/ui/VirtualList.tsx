...
export function VirtualList<T>({
  ...
  // Not using useFocusManager - allow input when component is visible
  ...
  useSafeInput(
    (input, key) => {
      // Allow keyboard input whenever the component is rendered
    ...
    { isActive: true, activeModes: ['normal'], respectFocus: false }
  );
